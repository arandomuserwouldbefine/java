    ...
    <div class="container">
      ...
      <div class="row block-9">
        <div class="col-md-6 order-md-last d-flex">
          <form action="CustomerController" method="POST" class="bg-white p-5 contact-form">
          <h1>Customer Register</h1>
            ...
            <div class="form-group">
              <input type="number" name="contact" class="form-control" placeholder="Your Contact" name="contact">
            </div>
            <div class="form-group">
