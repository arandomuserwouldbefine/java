...
<a class="dropdown-item" href="seller-login.jsp">Login</a>
<a class="dropdown-item" href="seller-register.jsp">Register</a>
</div>
</li>
<li class="nav-item dropdown">
<a class="nav-link dropdown-toggle" href="#" id="dropdown04" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Customer</a>
<div class="dropdown-menu" aria-labelledby="dropdown04">
<a class="dropdown-item" href="customer-login.jsp">Login</a>
<a class="dropdown-item" href="customer-register.jsp">Register</a>
</div>
</li>
